...
class Exp(MyExp):
    def __init__(self):
        ...
        self.output_dir = '/work1/gitlab-runner-docker-data/models/streamyolo/yolox_sfp32'
        #self.output_dir = '/work1/gitlab-runner-docker-data/streamYOLOyolox_s_trained'
    def get_model(self):
